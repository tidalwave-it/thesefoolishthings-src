...
public class FinderSupport<Type, ExtendedFinder extends Finder<Type>> implements Finder<Type>, Cloneable
  {
     ...
     *
     ******************************************************************************************************************/
    protected FinderSupport (final @Nonnull FinderSupport<Type, ExtendedFinder> other, final @Nonnull Object override)
      {
        log.debug("FinderSupport({}, {})", other, override);
        final FinderSupport<Type, ExtendedFinder> source = getSource(FinderSupport.class, other, override);
//            override.getClass().equals(FinderSupport.class) ? (FinderSupport<Type, ExtendedFinder>) override : other;
        ...
        try
          {
            ...
            return (FinderSupport<Type, ExtendedFinder>)clone(new Object());
          }
        catch (Exception e) 
          {
     ...
     ******************************************************************************************************************/
    @Nonnull
    protected ExtendedFinder clone (final @Nonnull Object override)
      {
        try
          {
            ...
            return (ExtendedFinder)constructor.newInstance(this, override);
          }
        catch (Exception e) 
          {
            throw new RuntimeException(e);
    ...
    public ExtendedFinder from (final @Nonnegative int firstResult)
      {
        return clone(new FinderSupport<Type, ExtendedFinder>(name, firstResult, maxResults, sorters));
      }
